...
GC_SYS_LOAD_THRESHOLD_MULTIPLIER=${GC_SYS_LOAD_THRESHOLD_MULTIPLIER:-0.3}
G1PERIODIC_LT_DEF=$(echo $CPU_COUNT*$GC_SYS_LOAD_THRESHOLD_MULTIPLIER | bc 2>/dev/null | sed 's/^\./0./')
